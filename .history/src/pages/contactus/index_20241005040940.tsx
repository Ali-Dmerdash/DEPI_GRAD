...
const ContactUs = () => {
  ...
  <Grid item xs={12} md={6}>
    <Card sx={{ p: 0, m: 0 }}> {/* Remove padding and margin from the Card */}
      <CardContent sx={{ p: 0, m: 0 }}> {/* Remove padding and margin from the CardContent */}
        <Box
          component="img"
          ...
          sx={{
            ...
            maxHeight: "70%", // Crops 30% of the bottom
