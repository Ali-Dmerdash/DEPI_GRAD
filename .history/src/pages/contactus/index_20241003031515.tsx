        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={6}>
            ...
            <Typography variant="body1">
              12345 Medical Office,<br />
              2nd Street, Healthcare Blvd,<br />
              San Francisco, CA<br />
              +1 (555) 123-4567<br />
            ...
            <Box mt={4}>
              ...
              <Typography variant="body2" gutterBottom>
                We’re always on the lookout for talented people. Explore our openings.
              </Typography>
          ...
          <Grid container spacing={4}>
            <Grid item xs={12} sm={4}>
              ...
              <Typography variant="body2">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque non risus nec lorem suscipit
                viverra ut ut neque.
              </Typography>
            </Grid>
