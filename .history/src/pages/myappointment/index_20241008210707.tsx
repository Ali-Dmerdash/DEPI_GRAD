...
const MyAppointment: React.FC = () => {
  return (
    ...
    <Box sx={{ maxWidth: 700, margin: "0 auto" }}>
      <Typography variant="body" color="initial" sx={{ marginBottom: "222%" }}>
        My Appointments
      </Typography>
          ...
          <Box display="flex" alignItems="flex-start">
            ...
            <Box flexGrow={1}>
              ...
              <Typography
                ...
                sx={{ marginBottom: "6%" }}
              >
                Address: <br /> 57th Cross, Richmond Circle, Church Road, London
              </Typography>
            ...
            >
              ...
              <Button variant="outlined" color="primary" sx={{ marginTop: 5 }}>
                Cancel appointment
              </Button>
            </Box>
          </Box>
