        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={6}>
            ...
            <Typography variant="body1" paragraph>
              ...
              scheduling doctor appointments and navigating the healthcare
              field.
            </Typography>
            <Typography variant="body1" paragraph>
              From routine general practices to healthcare technology, we
              continuously strive to enhance our platform, integrating the
              latest advancements to improve user experiences and deliver
              superior services.
            </Typography>
            <Typography variant="body1" paragraph>
              Our vision is to make healthcare accessible for every user,
              ensuring that the care you need is always within reach.
            </Typography>
          </Grid>
        </Grid>
